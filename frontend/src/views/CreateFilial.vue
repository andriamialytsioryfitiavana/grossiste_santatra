  ...
  <div class="card">
    ...
    <section class="form">
      ...
      <form class="body" @submit.prevent="submit">
        ...
        <label class="field">
          <span>Adresse</span>
          <input class="input" v-model="form.email" type="adresse" placeholder="Entrer votre adresse" />
        </label>
        <div class="row">
            <label class="field">
                <span>Ville</span>
                <input class="input" v-model="form.email" type="ville" placeholder="Entrer votre ville" />
            </label>
            <label class="field">
                <span>Pays</span>
                <input class="input" v-model="form.email" type="pays" placeholder="Entrer votre pays" />
            </label>
        </div>
        <label class="field">
          <span>Code d' accès</span>
          <div class="password">
            <input class="input" v-model="form.password" :type="passwordVisible ? 'text' : 'password'" placeholder="Entrer votre code d'accès" />
...
/* Right: form */
.form { background: linear-gradient(180deg, #0e5360 0%, #0e3e55 100%); color: #e9fffb; padding: 34px 32px; display: flex; flex-direction: column; justify-content: center; z-index: 1; }
...
.row { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; width: 95%;}
